...
export declare class VoyageAIClient {
     ...
     *     })
     */
    embed(request: VoyageAI.EmbedRequest, requestOptions?: VoyageAIClient.RequestOptions): core.HttpResponsePromise<VoyageAI.EmbedResponse>;
    private __embed;
    /**
     ...
     *     })
     */
    rerank(request: VoyageAI.RerankRequest, requestOptions?: VoyageAIClient.RequestOptions): core.HttpResponsePromise<VoyageAI.RerankResponse>;
    private __rerank;
    /**
     ...
     *     })
     */
    multimodalEmbed(request: VoyageAI.MultimodalEmbedRequest, requestOptions?: VoyageAIClient.RequestOptions): core.HttpResponsePromise<VoyageAI.MultimodalEmbedResponse>;
    private __multimodalEmbed;
    /**
     ...
     *     })
     */
    contextualizedEmbed(request: VoyageAI.ContextualizedEmbedRequest, requestOptions?: VoyageAIClient.RequestOptions): core.HttpResponsePromise<VoyageAI.ContextualizedEmbedResponse>;
    private __contextualizedEmbed;
}
