...
const waitUntilAssistantReady = async (assistantName) => {
    ...
    while (!isReady) {
        try {
            ...
            throw new Error(`Error while waiting for assistant to be ready: ${error}`, { cause: error });
        }
    }
};
...
const waitUntilAssistantFileReady = async (assistantName, fileId) => {
    ...
    while (!isReady) {
        try {
            ...
            throw new Error(`Error while waiting for assistant file to be ready: ${error}`, { cause: error });
        }
    }
};
