...
beforeAll(async () => {
    ...
    indexName = (0, test_helpers_1.randomName)('preview-list-docs');
    ...
    await (0, test_helpers_1.assertWithRetries)(() => pc.preview.index({ name: indexName }).listDocuments(namespace), (result) => {
...
//# sourceMappingURL=listDocuments.test.js.map