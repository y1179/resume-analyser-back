 ...
 */
export declare const getFetch: (config: Pick<PineconeConfiguration, "fetchApi" | "maxRetries">) => (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
/**
 ...
 * first read.
 */
export declare const getNonRetryingFetch: (config: Pick<PineconeConfiguration, "fetchApi">) => (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
