...
class Index {
    ...
    constructor(options, config) {
        ...
        const dataOperationsProvider = new vectorOperationsProvider_1.VectorOperationsProvider(config, this.target.indexName, this.target.indexHostUrl, options.additionalHeaders);
        ...
        this._upsertRecordsCommand = new upsertRecords_1.UpsertRecordsCommand(dataOperationsProvider, this.target.namespace, config);
        this._searchRecordsCommand = new searchRecords_1.SearchRecordsCommand(dataOperationsProvider, this.target.namespace);
        // bulk operations
        const bulkApiProvider = new bulkOperationsProvider_1.BulkOperationsProvider(config, this.target.indexName, this.target.indexHostUrl, options.additionalHeaders);
        ...
        const namespaceApiProvider = new namespacesOperationsProvider_1.NamespaceOperationsProvider(config, this.target.indexName, this.target.indexHostUrl, options.additionalHeaders);
