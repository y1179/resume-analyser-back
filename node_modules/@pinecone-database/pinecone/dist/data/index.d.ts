...
export declare class Index<T extends RecordMetadata = RecordMetadata> {
    ...
    /** @hidden */
    private _fetchByMetadataCommand;
    /** @hidden */
    ...
    /** @hidden */
    private _createNamespaceCommand;
    /** @hidden */
    private _listNamespacesCommand;
    /** @hidden */
    private _describeNamespaceCommand;
    /** @hidden */
    private _deleteNamespaceCommand;
    /** @internal */
    private config;
    /** @internal */
    private target;
    ...
    * ```
     ...
     */
    describeIndexStats(options?: DescribeIndexStatsOptions): Promise<import("./vectors/describeIndexStats").IndexStatsDescription>;
    /**
     ...
     */
    listPaginated(options?: ListOptions): Promise<import("..").ListResponse>;
    /**
     ...
     */
    upsert(options: UpsertOptions<T>): Promise<void>;
    /**
     ...
     */
    fetchByMetadata(options: FetchByMetadataOptions): Promise<import("./vectors/fetchByMetadata").FetchByMetadataResponse<T>>;
    /**
     ...
     */
    upsertRecords(options: UpsertRecordsOptions<T>): Promise<void>;
    /**
     ...
     */
    searchRecords(options: SearchRecordsOptions): Promise<import("..").SearchRecordsResponse>;
    /**
     ...
     */
    startImport(options: StartImportOptions): Promise<import("..").StartImportResponse>;
    /**
     ...
     */
    listImports(limit?: number, paginationToken?: string): Promise<import("..").ListImportsResponse>;
    /**
     ...
     */
    describeImport(id: string): Promise<import("..").ImportModel>;
    /**
     ...
     */
    createNamespace(options: CreateNamespaceOptions): Promise<import("..").NamespaceDescription>;
    /**
     ...
     */
    listNamespaces(options?: ListNamespacesOptions): Promise<import("..").ListNamespacesResponse>;
    /**
     ...
     */
    describeNamespace(namespace: string): Promise<import("..").NamespaceDescription>;
    /**
