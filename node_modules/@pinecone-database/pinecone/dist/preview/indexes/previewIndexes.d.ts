import type { IndexList as PreviewIndexList, IndexModel as PreviewIndexModel, BackupModel as PreviewBackupModel, BackupList as PreviewBackupList, CollectionList as PreviewCollectionList, CollectionModel as PreviewCollectionModel, CreateIndexFromBackupResponse as PreviewCreateIndexFromBackupResponse, RestoreJobList as PreviewRestoreJobList, RestoreJobModel as PreviewRestoreJobModel } from '../../pinecone-generated-ts-fetch-alpha/db_control';
import type { PineconeConfiguration } from '../../data';
import { PreviewCreateIndexOptions } from './createIndex';
import { PreviewConfigureIndexOptions } from './configureIndex';
import { PreviewCreateBackupOptions } from './createBackup';
import { PreviewListIndexBackupsOptions } from './listIndexBackups';
import { PreviewListProjectBackupsOptions } from './listProjectBackups';
import { PreviewCreateIndexFromBackupOptions } from './createIndexFromBackup';
import { PreviewListRestoreJobsOptions } from './listRestoreJobs';
import { PreviewCreateCollectionOptions } from './createCollection';
/**
 ...
 * @alpha
 */
export declare class PreviewIndexes {
    private _api;
    private _config;
     ...
     * @alpha
     */
    create(options: PreviewCreateIndexOptions): Promise<PreviewIndexModel>;
    /**
     ...
     * @alpha
     */
    describe(indexName: string): Promise<PreviewIndexModel>;
    /**
     ...
     * @alpha
     */
    configure(name: string, options: PreviewConfigureIndexOptions): Promise<PreviewIndexModel>;
    /**
     ...
     * @alpha
     */
    createBackup(indexName: string, options?: PreviewCreateBackupOptions): Promise<PreviewBackupModel>;
    /**
     ...
     * @alpha
     */
    listBackups(indexName: string, options?: PreviewListIndexBackupsOptions): Promise<PreviewBackupList>;
    /**
     ...
     * @alpha
     */
    listProjectBackups(options?: PreviewListProjectBackupsOptions): Promise<PreviewBackupList>;
    /**
     ...
     * @alpha
     */
    describeBackup(backupId: string): Promise<PreviewBackupModel>;
    /**
     ...
     * @alpha
     */
    createFromBackup(backupId: string, options: PreviewCreateIndexFromBackupOptions): Promise<PreviewCreateIndexFromBackupResponse>;
    /**
     ...
     * @alpha
     */
    listRestoreJobs(options?: PreviewListRestoreJobsOptions): Promise<PreviewRestoreJobList>;
    /**
     ...
     * @alpha
     */
    describeRestoreJob(jobId: string): Promise<PreviewRestoreJobModel>;
    /**
     ...
     * @alpha
     */
    listCollections(): Promise<PreviewCollectionList>;
    /**
     ...
     * @alpha
     */
    createCollection(options: PreviewCreateCollectionOptions): Promise<PreviewCollectionModel>;
    /**
     ...
     * @alpha
     */
    describeCollection(collectionName: string): Promise<PreviewCollectionModel>;
    /**
