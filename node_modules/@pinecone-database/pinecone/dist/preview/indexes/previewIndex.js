...
const updateDocuments_1 = require("./updateDocuments");
...
class PreviewIndex {
     ...
     * @alpha
     */
    async listDocuments(namespace, options = {}) {
        const api = await this._provider.provide();
        return (0, listDocuments_1.listPreviewDocuments)(api, namespace, options);
    }
    /**
     ...
     * @alpha
     */
    async updateDocuments(namespace, options) {
        const api = await this._provider.provide();
        return (0, updateDocuments_1.updatePreviewDocuments)(api, namespace, options);
    }
}
