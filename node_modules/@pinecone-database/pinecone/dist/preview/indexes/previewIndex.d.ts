...
import { PreviewListDocumentsOptions, PreviewListDocumentsResponse } from './listDocuments';
import { PreviewUpdateDocumentsOptions } from './updateDocuments';
...
export declare class PreviewIndex {
     ...
     * @alpha
     */
    listDocuments(namespace: string, options?: PreviewListDocumentsOptions): Promise<PreviewListDocumentsResponse>;
    /**
     ...
     * @alpha
     */
    updateDocuments(namespace: string, options: PreviewUpdateDocumentsOptions): Promise<void>;
}
