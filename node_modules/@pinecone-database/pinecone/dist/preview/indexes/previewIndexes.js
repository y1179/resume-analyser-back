...
exports.PreviewIndexes = void 0;
const alphaIndexOperationsBuilder_1 = require("./alphaIndexOperationsBuilder");
...
const listIndexBackups_1 = require("./listIndexBackups");
...
class PreviewIndexes {
    ...
    constructor(config) {
        this._config = config;
        this._api = (0, alphaIndexOperationsBuilder_1.alphaIndexOperationsBuilder)(config);
    }
    /**
     ...
     */
    async list() {
        const indexList = await (0, listIndexes_1.listPreviewIndexes)(this._api);
    ...
    async create(options) {
        const indexModel = await (0, createIndex_1.createPreviewIndex)(this._api, options);
    ...
    async describe(indexName) {
        const indexModel = await (0, describeIndex_1.describePreviewIndex)(this._api, indexName);
        const host = indexModel.privateHost || indexModel.host;
     ...
     */
    async delete(name) {
        await (0, deleteIndex_1.deletePreviewIndex)(this._api, name);
    ...
    async configure(name, options) {
        return (0, configureIndex_1.configurePreviewIndex)(this._api, name, options);
    }
    /**
     ...
     * @alpha
     */
    async createBackup(indexName, options) {
        return (0, createBackup_1.createPreviewBackup)(this._api, indexName, options);
    }
    /**
     ...
     * @alpha
     */
    async listBackups(indexName, options) {
        return (0, listIndexBackups_1.listPreviewIndexBackups)(this._api, indexName, options);
    }
    /**
     ...
     * @alpha
     */
    async listProjectBackups(options) {
        return (0, listProjectBackups_1.listPreviewProjectBackups)(this._api, options);
    }
    /**
     ...
     * @alpha
     */
    async describeBackup(backupId) {
        return (0, describeBackup_1.describePreviewBackup)(this._api, backupId);
    }
    /**
    ...
    async deleteBackup(backupId) {
        return (0, deleteBackup_1.deletePreviewBackup)(this._api, backupId);
    }
    /**
     ...
     * @alpha
     */
    async createFromBackup(backupId, options) {
        return (0, createIndexFromBackup_1.createIndexFromBackup)(this._api, backupId, options);
    }
    /**
     ...
     * @alpha
     */
    async listRestoreJobs(options) {
        return (0, listRestoreJobs_1.listPreviewRestoreJobs)(this._api, options);
    }
    /**
     ...
     * @alpha
     */
    async describeRestoreJob(jobId) {
        return (0, describeRestoreJob_1.describePreviewRestoreJob)(this._api, jobId);
    }
    /**
    ...
    async listCollections() {
        return (0, listCollections_1.listPreviewCollections)(this._api);
    }
    /**
    ...
    async createCollection(options) {
        return (0, createCollection_1.createPreviewCollection)(this._api, options);
    }
    /**
    ...
    async describeCollection(collectionName) {
        return (0, describeCollection_1.describePreviewCollection)(this._api, collectionName);
    }
    /**
    ...
    async deleteCollection(collectionName) {
        return (0, deleteCollection_1.deletePreviewCollection)(this._api, collectionName);
    }
}
exports.PreviewIndexes = PreviewIndexes;
//# sourceMappingURL=previewIndexes.js.map