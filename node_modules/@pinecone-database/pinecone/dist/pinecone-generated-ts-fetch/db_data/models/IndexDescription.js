...
function IndexDescriptionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'memoryFullness': !(0, runtime_1.exists)(json, 'memory_fullness') ? undefined : json['memory_fullness'],
        'storageFullness': !(0, runtime_1.exists)(json, 'storage_fullness') ? undefined : json['storage_fullness'],
    };
}
