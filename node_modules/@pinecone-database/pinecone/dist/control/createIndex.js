...
const createIndex = (api) => {
    return async (options) => {
        ...
        try {
            ...
            if (waitUntilReady) {
                return await (0, exports.waitUntilIndexIsReady)(api, options.name, timeout);
            }
...
const waitUntilIndexIsReady = (api, indexName, timeoutMs) => {
    return (0, utils_1.pollUntilIndexIsReady)(async () => {
        try {
            ...
            throw await (0, errors_1.handleApiError)(e, async (_, rawMessageText) => `Error waiting for index ${indexName} to be ready: ${rawMessageText}`);
        }
    }, indexName, timeoutMs);
};
