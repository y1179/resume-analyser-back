...
const createIndexForModel = (api) => {
    return async (options) => {
        ...
        try {
            ...
            if (waitUntilReady) {
                return await (0, createIndex_1.waitUntilIndexIsReady)(api, createResponse.name, timeout);
            }
