...
describe('createIndex', () => {
    ...
    describe('createIndex with BYOC spec', () => {
        ...
        test('throws error if BYOC environment is not provided', async () => {
            ...
            await expect(toThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(toThrow).rejects.toThrow('You must pass an `environment` for the `CreateIndexByocSpec` object to create an index.');
        });
    });
    describe('createIndex readCapacity validation', () => {
        test('throws error for invalid readCapacity mode', async () => {
            ...
            await expect(toThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(toThrow).rejects.toThrow(/Invalid read capacity mode.*Valid values are.*OnDemand.*Dedicated/i);
        });
        test('throws error for invalid dedicated nodeType', async () => {
            ...
            await expect(toThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(toThrow).rejects.toThrow(/Invalid node type.*Valid values are.*b1.*t1/i);
        });
        test('throws error for missing manual config in dedicated mode', async () => {
            ...
            await expect(toThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(toThrow).rejects.toThrow(/manual is required for dedicated mode/i);
        });
        test('throws error for invalid replicas value', async () => {
            ...
            await expect(toThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(toThrow).rejects.toThrow(/replicas must be 0 or a positive integer/i);
        });
        test('throws error for invalid shards value', async () => {
            ...
            await expect(toThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(toThrow).rejects.toThrow(/shards must be a positive integer/i);
        });
