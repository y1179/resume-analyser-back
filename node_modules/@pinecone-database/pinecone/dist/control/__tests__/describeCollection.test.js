...
describe('describeCollection', () => {
    describe('argument validation', () => {
        test('should throw if collection name is not provided', async () => {
            ...
            await expect(expectToThrow).rejects.toThrow(errors_1.PineconeArgumentError);
            await expect(expectToThrow).rejects.toThrow('You must pass a non-empty string for `name` in order to describe a collection');
        });
