...
const require_toolError = require("./agents/middleware/toolError.cjs");
...
var browser_exports = /* @__PURE__ */ require_runtime.__exportAll({
	...
	toolErrorMiddleware: () => require_toolError.toolErrorMiddleware,
...
exports.toolErrorMiddleware = require_toolError.toolErrorMiddleware;
